App = {
	...
	registerUser: function(event) {
		...
		console.log(name,email,mobile,pwd,aadhaar,dob,gender);
		...
		web3.eth.getAccounts(function(error,accounts){
			...
			App.contracts.register.deployed().then(function(instance){
				...
				return registerInstance.addAccount(web3.fromAscii(name),web3.fromAscii(email),web3.fromAscii(mobile), web3.fromAscii(aadhaar), web3.fromAscii(dob), web3.fromAscii(gender),web3.fromAscii(pwd),{from:account});
