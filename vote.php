...
<body onload="noBack();"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-xs-9">
                                        <div class="title">Nominee 1</div>
										 <a class="btn-action btn-round btn-gradient wow fadeIn btn-vote" data-id="0" data-wow-delay="0.2s">Vote</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-xs-9">
                                        <div class="title">Nominee 2</div>
                                         <a class="btn-action btn-round btn-gradient wow fadeIn btn-vote" data-id="1" data-wow-delay="0.2s">Vote</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="block">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-xs-9">
                                       ...
                                       <a class="btn-action btn-round btn-gradient wow fadeIn btn-vote" data-id="2" data-wow-delay="0.2s">Vote</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="src/js/js/voter.js"></script>
